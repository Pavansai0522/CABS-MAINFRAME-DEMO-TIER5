//CABU7110 JOB (CABS,UTIL),'CODE PAGE AND SIGN CONVERSIO',
//             CLASS=C,MSGCLASS=X,MSGLEVEL=(1,1),
//             NOTIFY=&SYSUID,REGION=0M,TIME=1440
//*****************************************************************
//* CABU7110 - CODE PAGE AND SIGN CONVERSION                      *
//*                                                               *
//* STEP010  CABUCV01                                             *
//* STEP020  CABUXR19                                             *
//*                                                               *
...
//*****************************************************************
//STEP010  EXEC PGM=CABUCV01,REGION=12M,
//             PARM='&CYCLE'
...
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7110STEP010 YY
/*
//*
//STEP020  EXEC PGM=CABUXR19,REGION=8M,
//             PARM='&CYCLE'
//STEPLIB  DD DSN=TELCABS.CABS.LOADLIB,DISP=SHR
//         DD DSN=TELCABS.COMMON.LOADLIB,DISP=SHR
//         DD DSN=SYS1.COB2LIB,DISP=SHR
...
//SYSUDUMP DD SYSOUT=D
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7110STEP020 YY
/*
//*
//
