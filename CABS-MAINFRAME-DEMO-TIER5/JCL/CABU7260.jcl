//CABU7260 JOB (CABS,UTIL),'SUSPENSE EXTRACT FOR THE REC',
//             CLASS=B,MSGCLASS=X,MSGLEVEL=(1,1),
//             NOTIFY=&SYSUID,REGION=0M,TIME=1440
//*****************************************************************
//* CABU7260 - SUSPENSE EXTRACT FOR THE RECYCLE JOB               *
//*                                                               *
//* STEP010  CABUEX24                                             *
//* STEP020  CABUCV11                                             *
//*                                                               *
...
//*****************************************************************
//STEP010  EXEC PGM=CABUEX24,REGION=4M,
//             PARM='&CYCLE'
...
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7260STEP010 NY
/*
//*
//STEP020  EXEC PGM=CABUCV11,REGION=6M,
//             PARM='&CYCLE'
//STEPLIB  DD DSN=TELCABS.CABS.LOADLIB,DISP=SHR
//         DD DSN=TELCABS.COMMON.LOADLIB,DISP=SHR
//         DD DSN=SYS1.COB2LIB,DISP=SHR
...
//SYSUDUMP DD SYSOUT=D
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7260STEP020 NN
/*
//*
//
