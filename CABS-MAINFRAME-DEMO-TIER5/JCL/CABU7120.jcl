//CABU7120 JOB (CABS,UTIL),'RATE ELEMENT DESCRIPTION MAI',
//             CLASS=A,MSGCLASS=X,MSGLEVEL=(1,1),
//             NOTIFY=&SYSUID,REGION=0M,TIME=1440
//*****************************************************************
//* CABU7120 - RATE ELEMENT DESCRIPTION MAINTENANCE               *
//*                                                               *
//* STEP010  CABURT13                                             *
//* STEP020  CABUEX15                                             *
//*                                                               *
...
//*****************************************************************
//STEP010  EXEC PGM=CABURT13,REGION=4M,
//             PARM='&CYCLE'
...
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7120STEP010 NY
/*
//*
//STEP020  EXEC PGM=CABUEX15,REGION=6M,
//             PARM='&CYCLE'
//STEPLIB  DD DSN=TELCABS.CABS.LOADLIB,DISP=SHR
//         DD DSN=TELCABS.COMMON.LOADLIB,DISP=SHR
//         DD DSN=SYS1.COB2LIB,DISP=SHR
...
//SYSUDUMP DD SYSOUT=D
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7120STEP020 NN
/*
//*
//
