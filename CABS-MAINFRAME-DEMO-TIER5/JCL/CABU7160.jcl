//CABU7160 JOB (CABS,UTIL),'RATE OVERRIDE TABLE LOAD',
//             CLASS=C,MSGCLASS=X,MSGLEVEL=(1,1),
//             NOTIFY=&SYSUID,REGION=0M,TIME=1440
//*****************************************************************
//* CABU7160 - RATE OVERRIDE TABLE LOAD                           *
//*                                                               *
//* STEP010  CABURT15                                             *
//* STEP020  CABUXR11                                             *
//*                                                               *
...
//*****************************************************************
//STEP010  EXEC PGM=CABURT15,REGION=8M,
//             PARM='&CYCLE'
...
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7160STEP010 YN
/*
//*
//STEP020  EXEC PGM=CABUXR11,REGION=4M,
//             PARM='&CYCLE'
//STEPLIB  DD DSN=TELCABS.CABS.LOADLIB,DISP=SHR
//         DD DSN=TELCABS.COMMON.LOADLIB,DISP=SHR
//         DD DSN=SYS1.COB2LIB,DISP=SHR
...
//SYSUDUMP DD SYSOUT=D
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7160STEP020 NY
/*
//*
//
