//CABU7300 JOB (CABS,UTIL),'ORPHAN KEY CROSS REFERENCE',
//             CLASS=A,MSGCLASS=X,MSGLEVEL=(1,1),
//             NOTIFY=&SYSUID,REGION=0M,TIME=1440
//*****************************************************************
//* CABU7300 - ORPHAN KEY CROSS REFERENCE                         *
//*                                                               *
//* STEP010  CABUXR15                                             *
//*                                                               *
...
//*****************************************************************
//STEP010  EXEC PGM=CABUXR15,REGION=12M,
//             PARM='&CYCLE'
...
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7300STEP010 YY
/*
//*
//
