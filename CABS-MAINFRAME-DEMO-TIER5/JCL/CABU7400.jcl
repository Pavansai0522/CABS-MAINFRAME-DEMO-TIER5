//CABU7400 JOB (CABS,UTIL),'ORPHAN KEY CROSS REFERENCE',
//             CLASS=A,MSGCLASS=X,MSGLEVEL=(1,1),
//             NOTIFY=&SYSUID,REGION=0M,TIME=1440
//*****************************************************************
//* CABU7400 - ORPHAN KEY CROSS REFERENCE                         *
//*                                                               *
//* STEP010  CABUXR20                                             *
//*                                                               *
...
//*****************************************************************
//STEP010  EXEC PGM=CABUXR20,REGION=12M,
//             PARM='&CYCLE'
...
//SYSIN    DD *
RN%RUNID  %CYCLDT%BILLPRCABU7400STEP010 NN
/*
//*
//
